...
export const salesService = {
  ...
  createInvoice(params: {
    ...
    const newInvoice: SaleInvoice = {
      id: generateId('sale'),
      invoiceNumber: generateInvoiceNumber('INV', state.salesInvoices.map(i => i.invoiceNumber)),
...
export const purchaseService = {
  ...
  createInvoice(params: {
    ...
    const newInvoice: PurchaseInvoice = {
      id: generateId('pur'),
      invoiceNumber: generateInvoiceNumber('PO', state.purchaseInvoices.map(i => i.invoiceNumber)),
