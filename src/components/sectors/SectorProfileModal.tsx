...
import { FocusTrap } from '@/components/ui/FocusTrap';import { useApp } from '@/context/AppContext';
...
export function SectorProfileModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <FocusTrap>
    <div role="dialog" aria-modal="true" className={`fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4 dir-rtl text-right`}>
