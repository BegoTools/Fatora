...
export function Purchases() {
  ...
  const handleAddOrder = () => {
    ...
    const total = subtotal + shippingCost + extraCharges.reduce((sum, ec) => sum + ec.amount, 0);

    const newInvoice: PurchaseInvoice = {
      id: generateId('pur'),
      invoiceNumber: generateInvoiceNumber('PO', purchaseInvoices.map(i => i.invoiceNumber)),
      ...
      if (safe) {
        dispatch({
          ...
          payload: {
            ...
            category: 'Purchases',
            description: `Payment to ${supplier.name} — PO ${payingInvoice.invoiceNumber}`,
            referenceNumber: payingInvoice.invoiceNumber,
